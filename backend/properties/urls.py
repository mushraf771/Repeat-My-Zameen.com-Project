...
from .views import AddPropertyView,PropertiesView, PropertyView, PlotsSearchView, ShopsSearchView, SearchView, PropertiesHomesView, PropertiesPlotsView, PropertiesShopsView
urlpatterns = [
