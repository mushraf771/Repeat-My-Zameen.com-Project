...
class Properties(models.Model):
    ...
    agent = UserForeignKey(auto_user_add=True,blank=False,
                   verbose_name="The user", related_name="agent")
    
    # models.ForeignKey(
    # UserAccount, on_delete=models.DO_NOTHING, related_name='agent')
    ...
    list_date = models.DateTimeField(default=now,null=True)
